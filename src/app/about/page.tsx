...
export default function AboutPage() {
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 py-6 md:gap-10 md:py-16">
      ...
      <section className="grid w-full max-w-5xl self-center gap-5 rounded-xl border border-slate-200 bg-white px-4 pt-4 pb-3 shadow-sm md:grid-cols-[1.25fr_1fr] md:px-5 md:pt-5 md:pb-4">
